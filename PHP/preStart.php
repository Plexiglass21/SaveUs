                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 pr-3 bg-black" style="width: max-content;">
                            <div class="card container 
                                ...
                                <img src="Img/G_icon_select.png" class="card-img-top mx-auto" alt="Guzzi" style="height: 200px; width: 200px;"> 
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 pl-3 bg-black" style="width: max-content;">
                            <div class="card container 
                                        ...
                                        style="width: max-content; background-color: rgba(255, 255, 255, 0.7);"> 
                                <img src="Img/V_icon_select.png" class="card-img-top mx-auto" alt="Guzzi" style="height: 200px; width: 200px;"> 
                                <div class="card-body">
